...
import com.faichuis.faichuismall.mapper.*;
import com.faichuis.faichuismall.model.*;
import com.faichuis.order.*;
import com.faichuis.order.domain.OmsOrderItemDomain;
import com.faichuis.order.response.*;
...
//    private OmsOrderMapper orderMapper;
    @Autowired
    private IOmsOrderItemDomainService orderItemDomainService;
//    @Autowired
//    private SmsCouponHistoryMapper couponHistoryMapper;
    ...
    @Autowired
    private IOmsOrderDomainService omsOrderDomainService;
//    @Autowired
...
//        portalOrderDao.findMemberOrderList(memberId,status)
        return CommonResult.success(Arrays.asList(new OmsOrderDetail()));
    }
    ...
    public ConfirmOrderResult generateConfirmOrder(List<Long> itemIds, Long memberId) throws BusinessException {
        ...
        //获取积分使用规则
        UmsIntegrationConsumeSetting integrationConsumeSetting = new UmsIntegrationConsumeSetting();
...
//        orderItemDomainService.batchInsert();
        //如使用优惠券更新优惠券使用状态
        if (orderParam.getCouponId() != null) {
    ...
    public CommonResult getDetailOrder(Long orderId){
        OmsOrderItemDomain omsOrderItemDomain = orderItemDomainService.queryById(21L);
        return CommonResult.success(omsOrderItemDomain);
    }
...
//                orderSettingMapper.selectByPrimaryKey(1L);
        //查询超时、未支付的订单及订单详情
        List<OmsOrderDetail> timeOutOrders = Lists.newArrayList();
...
//            portalOrderDao.releaseSkuStockLock(timeOutOrder.getOrderItemList());
    ...
    public void cancelOrder(Long orderId,Long memberId) {
        ...
        List<OmsOrder> cancelOrderList = Lists.newArrayList();
...
//        cancelOrderSender.sendMessage(mqCancelOrder, delayTimes);
    ...
    private void updateCouponStatus(Long couponId, Long memberId, Integer useStatus) {
        ...
        List<SmsCouponHistory> couponHistoryList = Lists.newArrayList();
//                couponHistoryMapper.selectByExample(example);
...
//                    skuStockMapper.selectByPrimaryKey(cartPromotionItem.getProductSkuId());
