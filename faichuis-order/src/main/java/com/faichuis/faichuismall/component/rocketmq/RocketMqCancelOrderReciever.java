package com.faichuis.faichuismall.component.rocketmq;

import com.faichuis.faichuismall.service.OmsPortalOrderService;
import com.faichuis.faichuismall.service.SecKillOrderService;
...
@Slf4j
@Component
@RocketMQMessageListener(consumerGroup = "${rocketmq.faichuismaill.cancelGroup}", topic = "${rocketmq.faichuismaill.scheduleTopic}")
