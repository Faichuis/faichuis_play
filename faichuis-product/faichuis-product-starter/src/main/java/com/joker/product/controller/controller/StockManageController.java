...
import com.joker.product.api.service.stock.StockManageService;
...
public class StockManageController {
    ...
    */
    ...
    public CommonResult lockStock(@RequestBody List<CartPromotionItemReq> cartPromotionItemList) {
